...
/**
 * Checks if tag is already contained within target.
 ...
 * @returns {boolean} Is tag already present in target
 */
 ...
 */
const _organizeSwaggerProperties = (
	swaggerObject,
	pathObject,
	propertyName
) => {
...
/**
 * Adds the data into the swagger object.
 * @function
...
module.exports = {
	...
	_objectMerge,
	swaggerizeObj,
	_getSwaggerSchemaWrongProperties,
	_correctSwaggerKey,
	_organizeSwaggerProperties,
