...
// Dependencies.
import RecursiveIterator from "./utils/recursive";
 ...
 */
export function _tagDuplicated(target, tag) {
 ...
 */
export function _attachTags(conf) {
	let { tag, swaggerObject, propertyName } = conf;
 ...
 */
export function _objectMerge(obj1, obj2) {
	let obj3 = {};
 ...
 */
export function _getSwaggerSchemaWrongProperties() {
	return [
		"consume",
		"produce",
		"path",
 ...
 */
export function _correctSwaggerKey(propertyName) {
 ...
 */
export function _organizeSwaggerProperties(
	swaggerObject,
	pathObject,
	propertyName
) {
	...
	if (propertyName === "components" || propertyName === "component") {
		...
		let definitionNames = Object.getOwnPropertyNames(
			pathObject["components"]["schemas"]
		);
 ...
 *                          comments
 */
export function addDataToSwaggerObject(swaggerObject, data) {
 ...
 */
export function seekWrong(list, wrongSet, problems) {
 ...
 */
export function findDeprecated(sources) {
	let wrong = _getSwaggerSchemaWrongProperties();
	let problems = [];
