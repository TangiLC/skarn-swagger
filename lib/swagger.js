...
import doctrineFile from "./df";
import swaggerUi from "swagger-ui-express";
import * as swaggerHelpers from "./helpers";
 ...
 * @requires doctrine
 */
export function parseApiFile(file) {
 ...
 * @requires js-yaml
 */
export function filterJsDocComments(jsDocComments) {
 ...
 * @requires glob
 */
export function convertGlobPaths(base, globs) {
	return globs.reduce(function (acc, globString) {
		let globFiles = globSync(globString);
 ...
 */
export function concatenateCurrentDate(options) {
 ...
 */
export function generateSpecAndMount(app) {
