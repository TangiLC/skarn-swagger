...
export function parseSchema(obj) {
	let nativeSchemas = [
		"object",
		"string",
		"integer",
...
export function parseItems(obj) {
	if (
		obj.applications &&
...
export function parseReturn(tags, responseFormats) {
	let rets = {};
...
export function parseDescription(obj) {
	const description = obj.description || "";
	const sanitizedDescription = description.replace("/**", "");
	return sanitizedDescription;
}

export function parseTag(tags) {
	for (let i in tags) {
...
export function parseProduces(str) {
	return str.split(/\s+/);
}

export function parseConsumes(str) {
	return str.split(/\s+/);
}

export function parseTypedef(tags) {
...
export function parseSecurity(comments) {
	let security;
	try {
...
export function parseHeaders(comments) {
	let headers = {};
...
export function parseEnums(description) {
